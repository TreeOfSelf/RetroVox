...
self.addEventListener('message', function(e) {
	...
	switch(message.id){
		...
		for(var h = 0 ; h<loopLen;h++){
			...
			LZString.compressToBase64(chunk[activeChunks[h]].blockList.toString()),
			LZString.compressToBase64(chunk[activeChunks[h]].culledList.toString()),
			]);
		}
		...
		chunk[chunkID].culledList = message.culledList;
		chunk[chunkID].chunkreDraw=1;
		break;
